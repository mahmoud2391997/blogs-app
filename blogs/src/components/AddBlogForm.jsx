...
export default function AddBlogForm({
  ...
  return (
    <div
      id={type}
      tabIndex={-1}
      className="hidden bg-gray-800 bg-opacity-70 h-screen overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0  max-h-full"
    >
        ...
        <div className=" w-full h-full ">
          <section className="w-full h-full border-black border-2 rounded-lg ">
            <div className="flex flex-col w-full justify-around items-center h-full">
              <input
                className="input input-bordered w-1/3  border-slate-950"
                id={type + "-source"}
              ...
              />
              <input
                className="input input-bordered w-5/6  border-slate-950"
                id={type + "-image"}
                placeholder=" Blog Pictur URL..."
                type="text"
                name="title"
              />
              <input
              ...
              <div className="flex justify-between w-5/6">
                <input
                  className="input input-bordered w-[45%]  border-slate-950"
                  id={type + "-pub-at"}
                  placeholder=" Blog Published At..."
                  type="text"
                  name="title"
                />
                <input
              ...
              <textarea
                className="input input-bordered w-5/6  h-28  border-slate-950"
                name="content"
                id={type + "-content"}
